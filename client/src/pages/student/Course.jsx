...
const Course = ({ course, viewMode = "grid", showProgress = false, variants }) => {
    ...
    >
      {viewMode === "list" ? (
        <Link to={`/course-detail/${course._id}`} className="block group h-full">
          <Card className="overflow-hidden rounded-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-md border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-600 h-full">
        ...
        // Grid view (default)
        <Link to={`/course-detail/${course._id}`} className="block group h-full">
          <Card className="overflow-hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-lg transition-all duration-300 w-full max-w-sm mx-auto h-full">
